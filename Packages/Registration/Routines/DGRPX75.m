...
25 S DW=".36;1",DV="*P8'Xa",DU="",DIFLD=.361,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C25^DGRPX75",DE(DW,"INDEX")=1
 S DU="DIC(8,"
 G RE
...
X30 S DFN=DA D AAC^DGLOCK2
 ...
 ;
31 S D=0 K DE(1) ;361
 S DIFLD=361,DGO="^DGRPX76",DC="3^2.0361IP^E^",DV="2.0361M*P8'X",DW="0;1",DOW=$$LABEL^DIALOGZ(DP,DIFLD),DLB=$P($$EZBLD^DIALOG(8042,DOW),": ") S:D DC=DC_D
 S DU="DIC(8,"
...
38 D:$D(DG)>9 F^DIE17,DE S DQ=38,D=0 K DE(1) ;.3731
 S DIFLD=.3731,DGO="^DGRPX77",DC="2^2.05A^.373^",DV="2.05MFX",DW="0;1",DOW=$$LABEL^DIALOGZ(DP,DIFLD),DLB=$P($$EZBLD^DIALOG(8042,DOW),": ") S:D DC=DC_D
