CRMSP000 ;EDE/SAB - post install ; Mar 20, 2023@12:57:56
 ;;1.0;CRMS - VAHC;**0**;OCT 2023;Build 13
 ;
 ; External calls:
 ;
 ; Post Install routine for patch CRMS*1*0
 ;
MAIN ; Control subroutine
 ...
 S XU8DATA(1)="CRMS VAHC DAS" ; Name
 S XU8DATA(2)="CRMS VAHC VIRTUAL CLINIC" ; ContextOption Name
 S XU8DATA(3)="CRMS VAHC VIRTUAL CLINIC Remote Application" ; ContextOption Menu Text
 S:$$PROD^XUPROD(1) XU8DATA(4)="p90HaC8wLdgxmSVT+L5U3ULTip3+Rka+B/2ajS2uJSA=" ; Security phrase - Production
 S:'$$PROD^XUPROD(1) XU8DATA(4)="6fJAyD6evr71DUnnGgS2fxXanRXmfliR/pSBORo73CM=" ; Security phrase - Non Production
