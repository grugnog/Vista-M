CRMSP001 ;EDE/SAB - post install ; Mar 20, 2023@12:57:56
 ;;1.0;CRMS - VAHC;**1**;OCT 2023;Build 12
 ;
 Q
 ;
MAIN ; Control subroutine
 ...
 S XU8DATA(1)="CRMS VCL MDFC" ; Name
 S XU8DATA(2)="CRMS VCL MDFC" ; ContextOption Name
 S XU8DATA(3)="CRMS VCL MEDORAFORCE Remote Application" ; ContextOption Menu Text
 S:$$PROD^XUPROD(1) XU8DATA(4)="qLV1S1y2NacIg5pdmsXXYdjJ0y+0EVVuMgSQRDJrGj8=" ; Security phrase - Production
 S:'$$PROD^XUPROD(1) XU8DATA(4)="D0PkIM5nTZ4G0gpQ8S+2ilbp8fhWupo6GUc0a3s5wEc=" ; Security phrase - Non Production
